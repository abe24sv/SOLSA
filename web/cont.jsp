                    ...
                    <div id="Search">
                        <div id="SearchCon">
                            <form method="POST" action="${sessionScope.searchurl}">
                                <input name="busca" id="SBar" class="Search Bar" type="text" placeholder="${sessionScope.searchtip}"/>
                ...
                <div id="List">
                    ...
                    <c:if test="${requestScope.verComprasApro == 1}">
                        ...
                        <div style="display: table-row;width: 100%;height: 20px;">
                            ...
                            <div class="Cell Head" style="width: 25%;">
                                Fecha de inicio
                            </div>
                            <div class="Cell Head" style="width: 25%;">
                                Fecha de entrega
                    ...
                    <c:if test="${requestScope.verCategorias == 1}">
                        <form action="./agregarCategoria" method="POST">
                            Nueva categoria:<input type="text" name="nom"/><br/>
                        ...
                        <div style="display: table-row;width: 100%;height: 20px;">
                           ...
                           <c:forEach items="${requestScope.listaCategorias}" var="i">
                               <div class="RowOpc"style="display: table-row;width: 100%;height: 20px;">
                            <div class="Cell" style="width: 5%;">
                                ${i.id}
                            </div>
                            ...
                            <div class="Cell Head" style="width: 20%;">
                                            <div class="Cell Head" style="width: 10%;">
                                                <form action="./editarCategoria" method="POST">
                                                    <input type="hidden" name="id" value="${i.id}"/>
                                                    <input type="hidden" name="nom" value="${i.nombre}"/>
                                                    
                                                    <a href="javascript:" onclick="parentNode.submit();">Editar</a>
                                                </form>
                                                <form action="./eliminarCategoria" method="POST">
                                                    <input type="hidden" name="id" value="${i.id}"/>
                                                    <a href="javascript:" onclick="parentNode.submit();">Eliminar</a>
                                                </form>
                                            </div>
                            </div>
                    ...
                    <c:if test="${requestScope.editarCategoria == 1}">
                        <form action="./cambiarCategoria" method="POST">
                            <input type="hidden" name="id" value="${requestScope.id}"/>
                            Editar Categoria<br/>
                            Nombre:<input type="text" name="nom" value="${requestScope.nombre}"/><br/>
                            <input type="submit" value="Cambiar"/>
                        </form>
                    </c:if>
                            <c:if test="${requestScope.verSubCategorias == 1}">
                        <form action="./agregarSubCategoria" method="POST">
                            Nueva subcategoria:<input type="text" name="nom"/><br/>
                            <select name="categoria">
                                <c:forEach items="${requestScope.categorias}" var="i">
                                    <option value="${i.id}">
                                        ${i.nombre}
                                    </option>
                                </c:forEach>
                        ...
                        <div style="display: table-row;width: 100%;height: 20px;">
                            ...
                            <div class="Cell Head" style="width: 30%;">
                               Categoria
                            </div>
                            <div class="Cell Head" style="width: 20%;">
                                Opciones
                           ...
                           <c:forEach items="${requestScope.listaSubCategorias}" var="i">
                               <div class="RowOpc"style="display: table-row;width: 100%;height: 20px;">
                            <div class="Cell" style="width: 5%;">
                                ${i.id}
                            </div>
                            ...
                            <div class="Cell Head" style="width: 20%;">
                                            <div class="Cell Head" style="width: 10%;">
                                                <form action="./editarSubCategoria" method="POST">
                                                    <input type="hidden" name="id" value="${i.id}"/>
                                                    <input type="hidden" name="nom" value="${i.nombre}"/>
                                                    <input type="hidden" name="categoria" value="${i.idCategoria}"/>
                                                    <a href="javascript:" onclick="parentNode.submit();">Editar</a>
                                                </form>
                                                <form action="./eliminarSubCategoria" method="POST">
                                                    <input type="hidden" name="id" value="${i.id}"/>
                                                    <a href="javascript:" onclick="parentNode.submit();">Eliminar</a>
                                                </form>
                                            </div>
                    ...
                    <c:if test="${requestScope.editarSubCategoria == 1}">
                        <form action="./cambiarSubCategoria" method="POST">
                            <input type="hidden" name="id" value="${requestScope.id}"/>
                            Editar Subcategoria<br/>
                            Nombre:<input type="text" name="nom" value="${requestScope.nombre}"/><br/>
                            Categoria:<select name="categoria">
                                <c:forEach items="${requestScope.categorias}" var="i">
                                    <c:set var="contains" value="false" />
                                          <c:if test="${requestScope.categoria eq i.id}">
                                            <c:set var="contains" value="true" />
                                          </c:if>
                                    <c:choose>
                                        <c:when test="${contains}">
                            ...
                            <c:if test="${requestScope.verProductosAlm == 1}">
                                <form action="./agProdAlm" method="POST">
                                    <a href="javascript:" onclick="parentNode.submit();">Agregar Producto</a>
                                </form>
                        <div style="position: relative;display: table;width: 98%;margin: 1%;font-size: 14px;">
                        <div style="display: table-row;width: 100%;height: 20px;">
                            <div class="Cell Head" style="width: 15%;">
                            ...
                            <div class="Cell Head" style="width: 40%;">
                               Descripcion
                            </div>
                            <div class="Cell Head" style="width: 10%;">
                               Cantidad
                           ...
                           <c:forEach items="${requestScope.listaProductosAlm}" var="i">
                               <div class="RowOpc"style="display: table-row;width: 100%;height: 20px;">
                            <div class="Cell" style="width: 15%;">
                                <img scr="${i.imagen}"/>
                            </div>
                            ...
                            <div class="Cell Head" style="width: 20%;">
                                            <div class="Cell Head" style="width: 10%;">
                                                <form action="./editarProdAlm" method="POST">
                                                    <input type="hidden" name="id" value="${i.id}"/>
                                                    <input type="hidden" name="nom" value="${i.nombre}"/>
                                                    <input type="hidden" name="categoria" value="${i.id_categoria}"/>
                                                    <a href="javascript:" onclick="parentNode.submit();">Editar</a>
                                                </form>
                                                <form action="./eliminarProdAlm" method="POST">
                                                    <input type="hidden" name="id" value="${i.id}"/>
                                                    <a href="javascript:" onclick="parentNode.submit();">Eliminar</a>
                                                </form>
                                            </div>
                            ...
                            <c:if test="${requestScope.agregarProductosAlm == 1}">
                                <form action="./agregarProdAlm" method="POST" enctype="multipart/form-data">
                                    Nombre:<input type="text" name="nombre"/><br/>
                                    Descripcion:<input type="text" name="descripcion"/><br/>
                                    Cantidad:<input type="number" name="cantidad" value="1"/><br/>
                                    Marca:<select name="marca">
                                        <c:forEach items="${requestScope.marcas}" var="i">
                                            <option value="${i.id}">
                                                ${i.nombre}
                                            </option>
                                        </c:forEach>
                                    ...
                                    Subcategoria:<select name="subcategoria">
                                        <c:forEach items="${requestScope.subcategorias}" var="i">
                                            <option value="${i.id}">
                                                ${i.nombre}
                                            </option>
                                        </c:forEach>
                                    </select><br/>
                                    Imagen <input type="file" name="logo"/><br/>
                                    <input type="submit" value="Agregar"/>
                                </form>
                            </c:if>
            </div>
