...
public class UsuarioAlmacen extends Usuario{
    ...
    public static void interfaz(HttpServletRequest request){
        ...
        interfazlat.add(new Opcion("Ordenes de Envío",new DivLateral(false,new Link("Por Fecha","./ListOrdDate"),new Link("Por Cliente","./ListOrdCli"),new Link("Por Producto","./ListOrdProd"))));
