...
public class ListOrdCli extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(con!=null){
            ...
            try{
               ...
               PreparedStatement query3=con.prepareStatement("SELECT * FROM (compra JOIN cliente ON compra.id_cliente = cliente.id) JOIN usuario ON compra.id_usuario = usuario.id WHERE estado > 3 ORDER BY cliente.nombre ASC;");
