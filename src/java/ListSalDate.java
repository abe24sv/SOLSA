...
public class ListSalDate extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(con!=null){
            ...
            try{
                PreparedStatement query=con.prepareStatement("SELECT * FROM venta JOIN compra ON venta.id_compra = compra.id ORDER BY compra.fecha_inicio DESC");
