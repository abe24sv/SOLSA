...
public class ListSalMade extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(con!=null){
            ...
            try{
               ...
               PreparedStatement query3=con.prepareStatement("SELECT * FROM (compra JOIN cliente ON compra.id_cliente = cliente.id) JOIN usuario ON compra.id_usuario = usuario.id WHERE compra.id_usuario = ? ;");
               query3.setInt(1, id);
