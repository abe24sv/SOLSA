...
public class ListToReceive extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(con!=null){
            ...
            try{
                ...
                Usuario user = (UsuarioAprobador)session.getAttribute("user");
               ...
               PreparedStatement query3=con.prepareStatement("SELECT * FROM (compra JOIN cliente ON compra.id_cliente = cliente.id) JOIN usuario ON compra.id_usuario = usuario.id WHERE compra.id_usuario = ? AND compra.estado = 5;");
               query3.setInt(1, id);
               ...
               url="/main.jsp";  
                ...
                request.setAttribute("comprasAprobador", listaCompras);
                //request.setAttribute("noEdit", 1);
                request.setAttribute("receive",1);
